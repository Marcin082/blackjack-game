...
export type gameAction = SettingStart | SettingInsurance | SettingRound | SettingBet | SettingCash | SettingResult | MakingSummary | DeletingBet | ClearingBet | DoublingingBet ;
